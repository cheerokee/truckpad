 ...
 */
class Motorista extends \Cadastro\Entity\Motorista implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cadastro\\Entity\\Motorista' . "\0" . 'id', '' . "\0" . 'Cadastro\\Entity\\Motorista' . "\0" . 'criado_em', '' . "\0" . 'Cadastro\\Entity\\Motorista' . "\0" . 'atualizado_em', '' . "\0" . 'Cadastro\\Entity\\Motorista' . "\0" . 'nome', '' . "\0" . 'Cadastro\\Entity\\Motorista' . "\0" . 'telefone', '' . "\0" . 'Cadastro\\Entity\\Motorista' . "\0" . 'data_nascimento', '' . "\0" . 'Cadastro\\Entity\\Motorista' . "\0" . 'idade', '' . "\0" . 'Cadastro\\Entity\\Motorista' . "\0" . 'cnh', '' . "\0" . 'Cadastro\\Entity\\Motorista' . "\0" . 'tipo_cnh', '' . "\0" . 'Cadastro\\Entity\\Motorista' . "\0" . 'cpf', '' . "\0" . 'Cadastro\\Entity\\Motorista' . "\0" . 'ativo', '' . "\0" . 'Cadastro\\Entity\\Motorista' . "\0" . 'sexo'];
        }
    ...
    public function getTipoCnh()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTipoCnh', []);

        return parent::getTipoCnh();
    }
    ...
    public function setTipoCnh($tipo_cnh)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTipoCnh', [$tipo_cnh]);

        return parent::setTipoCnh($tipo_cnh);
    }

...
namespace DoctrineORMModule\Proxy\__CG__\Transporte\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Veiculo extends \Transporte\Entity\Veiculo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Transporte\\Entity\\Veiculo' . "\0" . 'id', '' . "\0" . 'Transporte\\Entity\\Veiculo' . "\0" . 'criado_em', '' . "\0" . 'Transporte\\Entity\\Veiculo' . "\0" . 'atualizado_em', '' . "\0" . 'Transporte\\Entity\\Veiculo' . "\0" . 'placa', '' . "\0" . 'Transporte\\Entity\\Veiculo' . "\0" . 'modelo', '' . "\0" . 'Transporte\\Entity\\Veiculo' . "\0" . 'cor', '' . "\0" . 'Transporte\\Entity\\Veiculo' . "\0" . 'categoria', '' . "\0" . 'Transporte\\Entity\\Veiculo' . "\0" . 'marca'];
        }

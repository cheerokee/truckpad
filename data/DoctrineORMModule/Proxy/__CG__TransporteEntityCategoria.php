 ...
 */
class Categoria extends \Transporte\Entity\Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Transporte\\Entity\\Categoria' . "\0" . 'id', '' . "\0" . 'Transporte\\Entity\\Categoria' . "\0" . 'nome', '' . "\0" . 'Transporte\\Entity\\Categoria' . "\0" . 'codigo'];
        }

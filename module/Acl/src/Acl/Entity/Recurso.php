 ...
 * @ORM\Entity(repositoryClass="Acl\Entity\RecursoRepository")
 */
class Recurso
{
    /**
     ...
     * @var boolean
     *
     * @ORM\Column(name="somente_admin", type="boolean", nullable=true)
     */
    private $somente_admin;
     ...
     * @return bool
     */
    public function isSomenteAdmin()
    {
        return $this->somente_admin;
    }

    /**
     * @param bool $somente_admin
     */
    public function setSomenteAdmin($somente_admin)
    {
        $this->somente_admin = $somente_admin;
    }
}

...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["features-forgot-forgot-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppFeaturesForgotForgotComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppFeaturesForgotForgotComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppFeaturesForgotForgotComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function ForgotComponent(authService, router, notifyMessage, formBuilder, changeRef) {
      ...
      _createClass(ForgotComponent, [{
        ...
        value: function submit() {
          ...
          this.authService.forgot(this.form.value).subscribe(function (response) {
            if (response.result) {
              _this.notifyMessage.success(response.msg);
            } else {
              _this.notifyMessage.error(response.msg);
            }

            _this.btnRecupera = true;

            _this.changeRef.detectChanges();
          }, function () {
            _this.notifyMessage.error("Houve um erro ao recuperar a senha!");
    ...
    ForgotComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/features/forgot/forgot.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./forgot.component.css */
      "./src/app/features/forgot/forgot.component.css")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _services_notify_message_service__WEBPACK_IMPORTED_MODULE_4__["NotifyMessageService"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"]])], ForgotComponent);
    /***/
  },
  ...
  /***/
  function srcAppFeaturesForgotForgotModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _forgot_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./forgot.component */
    "./src/app/features/forgot/forgot.component.ts");
    ...
    ForgotModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild([{
        path: '',
        component: _forgot_component__WEBPACK_IMPORTED_MODULE_6__["ForgotComponent"],
        data: {
          breadcrumbs: ['Dashboard', 'Forgot']
        }
...
//# sourceMappingURL=features-forgot-forgot-module-es5.js.map
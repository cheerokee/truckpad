...
const APP_CONFIG = {
    ...
    copyright: `2020 © TruckPad por&nbsp;<a href="http://www.inovensti.com.br" class="text-primary fw-500" title="Inovens Tecnologia da Informação" target="_blank">Inovens</a>`,
};
...
class BaseHttpService {
    ...
    getByLike(searchString = "", serachparams = { "filter": [], "order-by": [] }) {

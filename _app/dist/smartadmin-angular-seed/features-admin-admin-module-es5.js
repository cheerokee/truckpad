...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["features-admin-admin-module"], {
    ...
    function () {
      ...
      _createClass2(ListarComponent, [{
        ...
        value: function clearFilter() {
          ...
          try {
            for (var _iterator8 = this.filter[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
      ...
      function PerfilPanelComponent(router, authService, usuarioHttp, imageHttp, formBuilder, changeRef, notifyMessage, functions) {
        ...
        this.router.events.subscribe(function (evt) {
          if (evt instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]) {
            ...
            _this33.router.navigated = false; // if you need to scroll back to top, here is the right place
      ...
      _createClass2(PerfilPanelComponent, [{
        ...
        value: function submitGeral() {
          ...
          this.usuarioHttp.update(this.usuario.id, this.form.value).subscribe(function (usuario) {
            ...
            _this35.notifyMessage.success('Seus dados foram atualizados');

            _this35.changeStatusBtnGeral(true);
          });
        }
      }, {
        key: "resetGeral",
        ...
        value: function submitTrocaSenha() {
          ...
          this.usuarioHttp.update(this.usuario.id, {
            ...
            _this36.defineFormularioTrocaSenha();

            _this36.notifyMessage.success('Sua senha foi alterada com sucesso');

            _this36.changeStatusBtnTrocasenha(true);
          });
        }
      }, {
        ...
        value: function recortar() {
          ...
          this.imageHttp.saveCropImage({
            ...
            _this37.usuarioHttp.update(_this37.usuario.id, {
              image: resolve.image
            }).subscribe(function (usuario) {
              _this37.authService.setUsuarioSession(usuario);

              $("#cropImage").modal('hide');

              _this37.changeRef.detectChanges();
              ...
              _this37.notifyMessage.error("Houve um erro ao atualizar a imagem de perfil");
            });
          }, function (error) {
            console.log(error);
        ...
        value: function refresh() {
          ...
          this.router.navigateByUrl('/', {
            ...
            console.log(_this38.router.url);

            _this38.router.navigate(["/admin/perfil-panel"]);
          });
        }
      }]);
  ...
  function srcAppServicesHttpGetterTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function HttpGetter(recursoHttpService, acaoHttpService, perfilHttpService, possibilidadeHttpService, usuarioHttpService, motoristaHttpService) {
  ...
  function srcAppServicesHttpAclAcaoHttpServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_base_http_service__W) {
      ...
      function AcaoHttpService(http, authService) {
        ...
        _this39 = _possibleConstructorReturn(this, _getPrototypeOf(AcaoHttpService).call(this, http, authService, "/acao"));
      ...
      _createClass2(AcaoHttpService, [{
        ...
        value: function listAll() {
          ...
          return new Promise(function (resolve) {
            ...
            _this40.list(serachparams).subscribe(function (response) {
              ...
              try {
                for (var _iterator9 = response._embedded[_this40.table][Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
              ...
              if (page_total > 1) {
                (function () {
                  ...
                  while (page_current <= page_total) {
                    _this40.list(serachparams, page_current).subscribe(function (response) {
                      var _iteratorNormalCompletion10 = true;
                      var _didIteratorError10 = false;
                      var _iteratorError10 = undefined;

                      try {
                        for (var _iterator10 = response._embedded[_this40.table][Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
  ...
  function srcAppServicesHttpAclPossibilidadeHttpServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_base_http_service__W2) {
      ...
      function PossibilidadeHttpService(http, authService) {
        ...
        _this41 = _possibleConstructorReturn(this, _getPrototypeOf(PossibilidadeHttpService).call(this, http, authService, '/possibilidade'));
        _this41.authService = authService;
        _this41.table = 'possibilidade';
        return _this41;
      }
      ...
      _createClass2(PossibilidadeHttpService, [{
        ...
        value: function listAll() {
          ...
          var _super = Object.create(null, {
            listAll: {
              get: function get() {
                return _get(_getPrototypeOf(PossibilidadeHttpService.prototype), "listAll", _this42);
              }
            }
          });
  ...
  function srcAppServicesHttpAclRecursoHttpServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_base_http_service__W3) {
      ...
      function RecursoHttpService(http, authService) {
        ...
        _this43 = _possibleConstructorReturn(this, _getPrototypeOf(RecursoHttpService).call(this, http, authService, '/recurso'));
        _this43.authService = authService;
        _this43.table = 'recurso';
        return _this43;
      }
      ...
      _createClass2(RecursoHttpService, [{
        ...
        value: function listAll() {
          ...
          var _super = Object.create(null, {
            listAll: {
              get: function get() {
                return _get(_getPrototypeOf(RecursoHttpService.prototype), "listAll", _this44);
              }
            }
          });
  ...
  function srcAppServicesHttpCadastroMotoristaHttpServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_base_http_service__W4) {
      ...
      function MotoristaHttpService(http, authService) {
        ...
        _this45 = _possibleConstructorReturn(this, _getPrototypeOf(MotoristaHttpService).call(this, http, authService, '/motorista'));
